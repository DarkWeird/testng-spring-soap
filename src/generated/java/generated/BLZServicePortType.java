...
public interface BLZServicePortType {
     ...
     * @param blz
     * @return
     *     returns generated.DetailsType
     */
    @WebMethod
    @WebResult(name = "details", targetNamespace = "http://thomas-bayer.com/blz/")
    @RequestWrapper(localName = "getBank", targetNamespace = "http://thomas-bayer.com/blz/", className = "generated.GetBankType")
    @ResponseWrapper(localName = "getBankResponse", targetNamespace = "http://thomas-bayer.com/blz/", className = "generated.GetBankResponseType")
