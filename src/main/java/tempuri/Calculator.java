 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/Users/lord/IdeaProjects/testng-spring-soap/calc.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/Users/lord/IdeaProjects/testng-spring-soap/calc.xml");
